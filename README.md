...
[![NuGet](https://img.shields.io/nuget/v/GroupDocs.Markdown.Mcp?label=NuGet)](https://www.nuget.org/packages/GroupDocs.Markdown.Mcp)
[![NuGet downloads](https://img.shields.io/nuget/dt/GroupDocs.Markdown.Mcp?label=downloads)](https://www.nuget.org/packages/GroupDocs.Markdown.Mcp)
[![Docker pulls](https://img.shields.io/docker/pulls/groupdocs/markdown-net-mcp?label=docker%20pulls)](https://hub.docker.com/r/groupdocs/markdown-net-mcp)
[![MCP Registry](https://img.shields.io/badge/MCP_Registry-listed-6f42c1)](https://registry.modelcontextprotocol.io/v0/servers?search=io.github.groupdocs-markdown/groupdocs-markdown-mcp)
[![Integration tests](https://github.com/groupdocs-markdown/GroupDocs.Markdown.Mcp.Tests/actions/workflows/integration.yml/badge.svg)](https://github.com/groupdocs-markdown/GroupDocs.Markdown.Mcp.Tests/actions/workflows/integration.yml)
...
**The MCP server itself is MIT; the underlying GroupDocs.Markdown engine requires a license
for production use.** Without one the server runs in **evaluation mode**:

- Output may be limited and carries an evaluation notice.
...
- [Purchase a license](https://purchase.groupdocs.com/pricing/markdown/net) | [Product page](https://products.groupdocs.com/markdown/net/)
...
> `"GroupDocs.Markdown.Mcp@26.7.1"` in `args`. Pinning is recommended for
...
> `"GroupDocs.Markdown.Mcp@26.7.1"` to lock to a specific release.
