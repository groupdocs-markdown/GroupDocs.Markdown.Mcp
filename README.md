...
```bash
dnx GroupDocs.Markdown.Mcp@26.9.0 --yes
```
...
> `"GroupDocs.Markdown.Mcp@26.9.0"` in `args`. Pinning is recommended for
...
> `"GroupDocs.Markdown.Mcp@26.9.0"` to lock to a specific release.
