...
Only the **latest released version** of `GroupDocs.Markdown.Mcp` (NuGet / GHCR / Docker Hub)
...
- Use GitHub's [private vulnerability reporting](https://github.com/groupdocs-markdown/GroupDocs.Markdown.Mcp/security/advisories/new)
...
- Vulnerabilities in the underlying `GroupDocs.Markdown` engine (a closed-source NuGet
